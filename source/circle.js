        ...
        if (node) {
            ...
            if (type.custom && node.custom_options && node.custom_options.length > 0) {
                    ...
                    try {
                        ...
                        if (reader) {
                            ...
                            if (Array.isArray(custom_options)) {
                                const attribute = createAttribute(null, 'custom_options', custom_options);
                                ...
                                for (const [key, value] of Object.entries(custom_options)) {
                                    ...
                                    const attribute = createAttribute(schema, key, value);
                                    this.attributes.push(attribute);
                                }
                                decoded = true;
                            }
                ...
                if (!decoded) {
                    ...
                    const attribute = createAttribute(schema, 'custom', Array.from(node.custom_options));
                    this.attributes.push(attribute);
                }
            }
            ...
            if (options) {
                for (const [name, value] of Object.entries(options)) {
                    ...
                    const attribute = createAttribute(schema, name, value);
                    this.attributes.push(attribute);
                }
            }
        }
